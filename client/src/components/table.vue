  ...
  computed: {
    ...
    methods: {
      ...
      move(evt) {
        ...
        this.$store.dispatch('updateTable', this.tableData);
      },
      save({title}) {
      ...
      saveTask(){
        ...
        if(task.title == '') {
          this.$store.dispatch('handleError', new Error(this.$t('Enter name')))
          return
        }
      ...
      deleteTable(){
        if(confirm(this.$t('Are you sure?')))
           this.$store.dispatch('deleteTable', this.tableData._id);
      },
      reorder(direction){
        this.$store.dispatch('sortTables', {
          up: direction.up,
          down: direction.down,
          tableId: this.tableData._id
        });
