<template>
  <div id="toolbar">
    <div id="nav" :class="{scrolled}">
      ...
      <mu-icon-button @click="toggleSidebar('open')" icon="menu"/>
  ...
  computed: {
    ...
    leaf(){
      ...
      if(this.$route.meta.title)
        return this.$route.meta.title[this.$i18n.locale()]
      return false
    },
    parent(){
      if(this.$route.name === 'Card'){
    ...
    ...mapGetters(['scrolled','events','user','board','card','isAdmin','isCardAdmin'])
  },
};
</script>
